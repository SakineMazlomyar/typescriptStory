class StoryStep {
    ...
    question:string;
    cases: any;
    constructor(id:number, question:string, cases:any){
        this.id = id
...
let storySteps : {id:number, question:string, cases:{left:{id:number, answer:string}, right:{id:number, answer:string} }}[] = []
...
let curreStep: {id:number, question:string, cases:{left:{id:number, answer:string}, right:{id:number, answer:string} }}
